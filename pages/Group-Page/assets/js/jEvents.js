...
window.addEventListener('load', function () {
    console.log('%c' + '> Events page images and other resources all loaded.', 'background-color: black; color: white; padding: 0.5em 0em; font-weight: bold;'); // Provide an initial load message.
...
function init() {
    console.log('%c' + '> Events page DOM content loaded.', 'background-color: black; color: white; padding: 0.5em 0em; font-weight: bold;'); // Provide an initial load message.
