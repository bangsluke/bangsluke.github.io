function ConditionalFormattingTaskTab() {
    ...
    */
    ...
    var taskLongNameColumnLetter = "E";
    var taskDescriptionColumnLetter = "F";
    var LastDataColumnLetter = "G";
    var LineStatusColumnLetter = "I";
    var RemarkColumnLetter = "J";
    var OwnerColumnLetter = "L";
    var HasDeliverableCountColumnLetter = "O";
    var HasPrerequisiteCountColumnLetter = "P";
    ...
    CurrentSpreadsheet.getRange(swimlaneIDColumnLetter + FirstRow + ':' + swimlaneIDColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    CurrentSpreadsheet.getRange(LastDataColumnLetter + FirstRow + ':' + LastDataColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    CurrentSpreadsheet.getRange(HasDeliverableCountColumnLetter + FirstRow + ':' + HasPrerequisiteCountColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    ...
    Protection = CurrentSpreadsheet.getRange(swimlaneIDColumnLetter + FirstRow + ':' + swimlaneIDColumnLetter + LastRow).protect(); 
    Protection.removeEditors(UserEmailString.toString().split(","));
    Protection = CurrentSpreadsheet.getRange(LastDataColumnLetter + FirstRow + ':' + LastDataColumnLetter + LastRow).protect(); 
    Protection.removeEditors(UserEmailString.toString().split(","));
    ...
    ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
       .setRanges([CurrentSpreadsheet.getRange(idColumnLetter + FirstRow + ':' + LastDataColumnLetter + LastRow),CurrentSpreadsheet.getRange(OwnerColumnLetter + FirstRow + ':' + OwnerColumnLetter + LastRow)])             
    ...
    for (i = 1; i <= SwimlaneArraySize; i++) {
      // Activity Formatting. Highlights the activity name, start, duration and task name for all swimlanes.
       ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
          .setRanges([CurrentSpreadsheet.getRange(FirstDataColumnLetter + FirstRow + ':' + nameColumnLetter + LastRow),CurrentSpreadsheet.getRange(taskLongNameColumnLetter + FirstRow + ':' + taskDescriptionColumnLetter + LastRow),CurrentSpreadsheet.getRange(OwnerColumnLetter + FirstRow + ':' + OwnerColumnLetter + LastRow)])
