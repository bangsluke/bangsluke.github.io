function ConditionalFormattingMilestoneHasPreactivityTab() {
 
    /**
    * ConditionalFormattingMilestoneHasPreactivityTab Function.
    * Conditionally formats the Milestone Has Preactivity tab.
    */
    
    // Add an alert to tell the user that the sheet is being formatted.
    var SpreadsheetUI = SpreadsheetApp.getUi();
    var ProperTabName = "Milestone Has Preactivity";
    var TabName = "milestone_has_preactivity";
    ...
    var milestoneIDColumnLetter = "C";
    var activityIDColumnLetter = "D";
    var maturityColumnLetter = "E";
    var ActiveColumnLetter = "G";
    var LastDataColumnLetter = "I";
    var LineStatusColumnLetter = "K";
    var RemarkColumnLetter = "L";
    var MilestoneColumnLetter = "N";
    var ActivityColumnLetter = "O";
    var OwnerColumnLetter = "P";
    var ownerIDColumnLetter = "Q";
    var ErrorCheckColumnLetter = "S";
    var FirstCheckColumnLetter = "U";
    var LastCheckColumnLetter = "Z";
    ...
    CurrentSpreadsheet.getRange(milestoneIDColumnLetter + FirstRow + ':' + activityIDColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    ...
    Protection = CurrentSpreadsheet.getRange(milestoneIDColumnLetter + FirstRow + ':' + activityIDColumnLetter + LastRow).protect(); 
    ...
    ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
       .setRanges([CurrentSpreadsheet.getRange(idColumnLetter + FirstRow + ':' + LastDataColumnLetter + LastRow),CurrentSpreadsheet.getRange(MilestoneColumnLetter + FirstRow + ':' + ActivityColumnLetter + LastRow)])             
    ...
    for (i = 1; i <= SwimlaneArraySize; i++) {
      // Activity Formatting. Highlights the Activity for all swimlanes.
       ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
          .setRanges([CurrentSpreadsheet.getRange(ActivityColumnLetter + FirstRow + ':' + ActivityColumnLetter + LastRow)])
