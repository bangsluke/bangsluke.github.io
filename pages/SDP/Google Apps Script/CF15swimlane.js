function ConditionalFormattingSwimlaneTab() {
    ...
    */
    ...
    var ProperTabName = "Swimlane";
    var TabName = "swimlane";
    ...
    var ErrorCheckColumnLetter = "O";
    var FirstCheckColumnLetter = "Q";
    var LastCheckColumnLetter = "W";
    //Logger.log(ProperTabName + ' Sheet: Column references set up.');
    
    // Clear all formatting below header row. Do not clear the formatting in the Hex columns.
    CurrentSpreadsheet.getRange(idColumnLetter + FirstRow + ':' + LastDataColumnLetter + LastRow).activate();
    CurrentSpreadsheet.getActiveRangeList().setBackground(null)
    .setFontColor(null);
    CurrentSpreadsheet.getRange(ErrorCheckColumnLetter + FirstRow + ':' + LastCheckColumnLetter + LastRow).activate();
    CurrentSpreadsheet.getActiveRangeList().setBackground(null)
    .setFontColor(null);
