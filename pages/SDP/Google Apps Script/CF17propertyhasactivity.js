function ConditionalFormattingPropertyHasActivityTab() {
 
    /**
    * ConditionalFormattingPropertyHasActivityTab Function.
    * Conditionally formats the Property Has Activity Tab.
    */
    
    // Add an alert to tell the user that the sheet is being formatted.
    var SpreadsheetUI = SpreadsheetApp.getUi();
    var ProperTabName = "Property Has Activity";
    var TabName = "property_has_activity";
    ...
    var propertyIDColumnLetter = "B";
    var activityIDColumnLetter = "C";
    var LastDataColumnLetter = "C";
    var LineStatusColumnLetter = "E";
    var RemarkColumnLetter = "F";
    var PropertyDescriptionColumnLetter = "H";
    var ActivityColumnLetter = "I";
    var TaskColumnLetter = "J";
    var OwnerColumnLetter = "K";
    var ownerIDColumnLetter = "L";
    var ErrorCheckColumnLetter = "N";
    var FirstCheckColumnLetter = "P";
    var LastCheckColumnLetter = "T";
    ...
    CurrentSpreadsheet.getRange(propertyIDColumnLetter + FirstRow + ':' + activityIDColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    CurrentSpreadsheet.getRange(TaskColumnLetter + FirstRow + ':' + ownerIDColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    ...
    Protection = CurrentSpreadsheet.getRange(propertyIDColumnLetter + FirstRow + ':' + activityIDColumnLetter + LastRow).protect(); 
    Protection.removeEditors(UserEmailString.toString().split(","));
    Protection = CurrentSpreadsheet.getRange(TaskColumnLetter + FirstRow + ':' + ownerIDColumnLetter + LastRow).protect();  
    Protection.removeEditors(UserEmailString.toString().split(","));
    ...
    ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
       .setRanges([CurrentSpreadsheet.getRange(idColumnLetter + FirstRow + ':' + LastDataColumnLetter + LastRow),CurrentSpreadsheet.getRange(PropertyDescriptionColumnLetter + FirstRow + ':' + ActivityColumnLetter + LastRow)])             
