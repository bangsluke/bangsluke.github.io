function ConditionalFormattingEdgeTab() {
    ...
    */
    ...
    var ActivityIDToColumnLetter = "D";
    var FromLoopNColumnLetter = "H";
    var ToLoopNColumnLetter = "I";
    var ActiveColumnLetter = "K";
    var LastDataColumnLetter = "M";
    var LineStatusColumnLetter = "O";
    var RemarkColumnLetter = "P";
    var ActivityFromColumnLetter = "T";
    var ActivityToColumnLetter = "U";
    var FromTaskColumnLetter = "V";
    var ToTaskColumnLetter = "W";
    var ErrorCheckColumnLetter = "Y";
    var FirstCheckColumnLetter = "AA";
    var LStrandCheckColumnLetter = "AI";
    var FromLoopNEdgeConnectionCheckColumnLetter = "AL";
    var ToLoopNEdgeConnectionCheckColumnLetter = "AM";
    var FromTaskOwnerColumnLetter = "AX";
    var ToTaskOwnerColumnLetter = "AY";
    var LastCheckColumnLetter = "BA";
    ...
    CurrentSpreadsheet.getRange(ActivityIDFromColumnLetter + FirstRow + ':' + ActivityIDToColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    ...
    Protection = CurrentSpreadsheet.getRange(ActivityIDFromColumnLetter + FirstRow + ':' + ActivityIDToColumnLetter + LastRow).protect(); 
    ...
    // LStrandCheckColumnLetter Column. Highlights fromLoopN or toLoopN columns.
    ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
       .setRanges([CurrentSpreadsheet.getRange(FromLoopNColumnLetter + FirstRow + ':' + ToLoopNColumnLetter + LastRow)])
       .whenFormulaSatisfied('=$' + LStrandCheckColumnLetter + FirstRow + '="Check"')
