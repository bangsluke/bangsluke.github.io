function ConditionalFormattingRegionTab() {
 
    /**
    * ConditionalFormattingRegionTab Function.
    * Conditionally formats the Region Tab.
    */
    
    // Add an alert to tell the user that the sheet is being formatted.
    var SpreadsheetUI = SpreadsheetApp.getUi();
    var ProperTabName = "Region";
    var TabName = "region";
    ...
    var ErrorCheckColumnLetter = "H";
    var FirstCheckColumnLetter = "J";
    var LastCheckColumnLetter = "L";
