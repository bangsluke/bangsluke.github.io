function ConditionalFormattingActivityHasDeliverableTab() {
 
    /**
    * ConditionalFormattingActivityHasDeliverableTab Function.
    * Conditionally formats the Activity Has Deliverable tab.
    */
    
    // Add an alert to tell the user that the sheet is being formatted.
    var SpreadsheetUI = SpreadsheetApp.getUi();
    var ProperTabName = "Activity Has Deliverable";
    var TabName = "activity_has_deliverable";
    ...
    var TaskColumnLetter = "O";
    var OwnerColumnLetter = "P";
    var ownerIDColumnLetter = "Q";
    var SupportTeamsColumnLetter = "S";
    var ErrorCheckColumnLetter = "U";
    var FirstCheckColumnLetter = "W";
    var LastCheckColumnLetter = "AE";
    ...
    .setFontColor(null)
    .setFontStyle('italic');
    CurrentSpreadsheet.getRange(TaskColumnLetter + FirstRow + ':' + SupportTeamsColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
