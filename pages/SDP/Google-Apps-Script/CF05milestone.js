function ConditionalFormattingMilestoneTab() {
    ...
    */
    ...
    var ProperTabName = "Milestone";
    var TabName = "milestone";
    ...
    var nameColumnLetter = "C";
    var taskIDColumnLetter = "D";
    var longNameColumnLetter = "E";
    var descriptionColumnLetter = "F";
    var evidenceColumnLetter = "G";
    var ActiveColumnLetter = "AE";
    var LastDataColumnLetter = "AF";
    var LineStatusColumnLetter = "AJ";
    var RemarkColumnLetter = "AK";
    var TaskColumnLetter = "AM";
    var OwnerColumnLetter = "AN";
    var ErrorCheckColumnLetter = "AP";
    var FirstCheckColumnLetter = "AR";
    var LastCheckColumnLetter = "AZ";
    ...
    CurrentSpreadsheet.getRange(taskIDColumnLetter + FirstRow + ':' + taskIDColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    CurrentSpreadsheet.getRange(descriptionColumnLetter + FirstRow + ':' + descriptionColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    CurrentSpreadsheet.getRange(OwnerColumnLetter + FirstRow + ':' + OwnerColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    ...
    Protection = CurrentSpreadsheet.getRange(taskIDColumnLetter + FirstRow + ':' + taskIDColumnLetter + LastRow).protect();  
    Protection.removeEditors(UserEmailString.toString().split(","));
    Protection = CurrentSpreadsheet.getRange(descriptionColumnLetter + FirstRow + ':' + descriptionColumnLetter + LastRow).protect(); 
    Protection.removeEditors(UserEmailString.toString().split(","));
    ...
    ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
       .setRanges([CurrentSpreadsheet.getRange(idColumnLetter + FirstRow + ':' + LastDataColumnLetter + LastRow),CurrentSpreadsheet.getRange(OwnerColumnLetter + FirstRow + ':' + TaskColumnLetter + LastRow)])             
    ...
    for (i = 1; i <= SwimlaneArraySize; i++) {
      // Activity Formatting. Highlights the activity name, start, duration and task name for all swimlanes.
       ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
          .setRanges([CurrentSpreadsheet.getRange(FirstDataColumnLetter + FirstRow + ':' + nameColumnLetter + LastRow),CurrentSpreadsheet.getRange(longNameColumnLetter + FirstRow + ':' + longNameColumnLetter + LastRow),CurrentSpreadsheet.getRange(evidenceColumnLetter + FirstRow + ':' + LastDataColumnLetter + LastRow),CurrentSpreadsheet.getRange(TaskColumnLetter + FirstRow + ':' + TaskColumnLetter + LastRow)])
