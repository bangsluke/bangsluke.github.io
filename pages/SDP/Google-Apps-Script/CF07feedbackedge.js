function ConditionalFormattingFeedbackEdgeTab() {
    ...
    */
    ...
    var ProperTabName = "Feedback Edge";
    var TabName = "feedbackedge";
    ...
    var fromActivityIDColumnLetter = "C";
    var toTaskIDColumnLetter = "D";
    var ActiveColumnLetter = "G";
    var LastDataColumnLetter = "I";
    var LineStatusColumnLetter = "K";
    var RemarkColumnLetter = "L";
    var FromActivityColumnLetter = "N";
    var FromTaskColumnLetter = "O";
    var ToTaskColumnLetter = "P";
    var ErrorCheckColumnLetter = "R";
    var FirstCheckColumnLetter = "T";
    var FromTaskOwnerColumnLetter = "AA";
    var ToTaskOwnerColumnLetter = "AB";
    var LastCheckColumnLetter = "AB";
    ...
    CurrentSpreadsheet.getRange(fromActivityIDColumnLetter + FirstRow + ':' + toTaskIDColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    CurrentSpreadsheet.getRange(FromTaskColumnLetter + FirstRow + ':' + FromTaskColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    ...
    Protection = CurrentSpreadsheet.getRange(fromActivityIDColumnLetter + FirstRow + ':' + toTaskIDColumnLetter + LastRow).protect(); 
    Protection.removeEditors(UserEmailString.toString().split(","));
    Protection = CurrentSpreadsheet.getRange(FromTaskColumnLetter + FirstRow + ':' + FromTaskColumnLetter + LastRow).protect();  
    Protection.removeEditors(UserEmailString.toString().split(","));
    ...
    ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
       .setRanges([CurrentSpreadsheet.getRange(idColumnLetter + FirstRow + ':' + LastDataColumnLetter + LastRow),CurrentSpreadsheet.getRange(FromActivityColumnLetter + FirstRow + ':' + ToTaskColumnLetter + LastRow)])             
       .whenFormulaSatisfied('=AND(NOT($B' + FirstRow + '=""),' + idColumnLetter + FirstRow + '="")')
    ...
    for (i = 1; i <= SwimlaneArraySize; i++) {
      // FromActivity Formatting. Highlights the From Activity for all swimlanes.
       ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
          .setRanges([CurrentSpreadsheet.getRange(FromActivityColumnLetter + FirstRow + ':' + FromActivityColumnLetter + LastRow)])
          ...
          .build());
      // ToTask Formatting. Highlights the To Task for all swimlanes.
       ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
