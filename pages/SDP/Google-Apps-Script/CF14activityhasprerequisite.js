function ConditionalFormattingActivityHasPrerequisiteTab() {
 
    /**
    * ConditionalFormattingActivityHasPrerequisiteTab Function.
    * Conditionally formats the Activity Has Prerequisite tab.
    */
    
    // Add an alert to tell the user that the sheet is being formatted.
    var SpreadsheetUI = SpreadsheetApp.getUi();
    var ProperTabName = "Activity Has Prerequisite";
    var TabName = "activity_has_prerequisite";
    ...
    var ErrorCheckColumnLetter = "R";
    var FirstCheckColumnLetter = "T";
    var LastCheckColumnLetter = "X";
