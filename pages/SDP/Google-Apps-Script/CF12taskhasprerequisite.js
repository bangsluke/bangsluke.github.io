function ConditionalFormattingTaskHasPrerequisiteTab() {
 
    /**
    * ConditionalFormattingTaskHasPrerequisiteTab Function.
    * Conditionally formats the Task Has Prerequisite tab.
    */
    
    // Add an alert to tell the user that the sheet is being formatted.
    var SpreadsheetUI = SpreadsheetApp.getUi();
    var ProperTabName = "Task Has Prerequisite";
    var TabName = "task_has_prerequisite";
