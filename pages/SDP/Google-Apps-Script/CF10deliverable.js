function ConditionalFormattingDeliverableTab() {
    ...
    */
    ...
    var ProperTabName = "Deliverable";
    var TabName = "deliverable";
    ...
    var DeliverableDescriptionColumnLetter = "C";
    var LastDataColumnLetter = "D";
    var RecommendedTargetColumnLetter = "G";
    var LineStatusColumnLetter = "I";
    var FirstSwimlaneColumn = "M";
    var LastSwimlaneColumn = "Y";
    var ErrorCheckColumnLetter = "AE";
    var FirstCheckColumnLetter = "AG";
    var LastCheckColumnLetter = "AM";
    //Logger.log(ProperTabName + ' Sheet: Column references set up.');
    
    // Formatting clear turned off to protect the swimlane deliverable count formatting.
    ...
    .setFontColor(null)
    .setFontStyle('italic');
    CurrentSpreadsheet.getRange(RecommendedTargetColumnLetter + FirstRow + ':' + RecommendedTargetColumnLetter + LastRow).setBackground('#efefef')
    .setFontColor(null)
    .setFontStyle('italic');
    ...
    //for (i = 1; i <= SwimlaneArraySize; i++) {
      // Activity Formatting. Highlights the activity name, start, duration and task name for all swimlanes.
       //ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
          //.setRanges([CurrentSpreadsheet.getRange(FirstDataColumnLetter + FirstRow + ':' + FirstDataColumnLetter + LastRow),CurrentSpreadsheet.getRange(DeliverableDescriptionColumnLetter + FirstRow + ':' + DeliverableDescriptionColumnLetter + LastRow)])
    ...
    // Make cells with 0 grey in swimlane columns.
    ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
       .setRanges([CurrentSpreadsheet.getRange(FirstSwimlaneColumn + '2:' + LastSwimlaneColumn + LastRow)])
    ...
    // Make blank cells grey in swimlane columns.
    ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
       .setRanges([CurrentSpreadsheet.getRange(FirstSwimlaneColumn + '2:' + LastSwimlaneColumn + LastRow)])
       .whenCellEmpty()
       .setBackground('#EFEFEF')
    ...
    ConditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
       .setRanges([CurrentSpreadsheet.getRange(idColumnLetter + FirstRow + ':' + LineStatusColumnLetter + LastRow)])
